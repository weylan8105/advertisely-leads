    ...
    <section className="container py-20 lg:py-28">
      <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            {[
              ...
              return (
                <div key={f.title} className="flex gap-3">
                  <div className="h-9 w-9 grid place-items-center rounded-md bg-slate-100 border border-slate-300 text-brand-red shrink-0">
        ...
        <div className="relative">
          <div className="absolute -inset-6 bg-gradient-to-br from-brand-red/15 via-transparent to-brand-redDark/20 blur-3xl pointer-events-none" />
          <div className="relative rounded-2xl border border-slate-300 bg-white backdrop-blur-xl p-6">
            ...
            <div className="mt-6 space-y-4">
              {[
                ["Tax-free retirement income", 38, "from-brand-red to-brand-redDark"],
