...
export const leadPackages: LeadPackage[] = [
  ...
  // leads → minimumOrder = max(25, ceil(150 / price)). So only $3 and $1 exceed 25.
  {
    ...
    ageMaxDays: 2,
    exclusive: true,
    features: ["🔒 Exclusive — sold only to you", "Under 48 hours old", "Highest answer rate", "TCPA consent captured"],
  ...
  },
  {
    ...
    ageMaxDays: 6,
    exclusive: true,
    features: ["🔒 Exclusive — sold only to you", "2–5 days old", "Near-fresh answer rates", "TCPA consent captured"],
  ...
  },
  {
    ...
    ageMaxDays: 30,
    exclusive: false,
    features: ["Shared — resold until marked sold", "6–29 days old", "Deep discount vs fresh", "TCPA consent captured"],
  ...
  },
  {
    ...
    ageMaxDays: 45,
    exclusive: false,
    features: ["Shared — resold until marked sold", "30–44 days old", "Deep volume pricing", "TCPA consent captured"],
  ...
  },
  {
    ...
    ageMaxDays: 90,
    exclusive: false,
    features: ["Shared — resold until marked sold", "45–89 days old", "Rock-bottom pricing", "TCPA consent captured"],
  ...
  },
  {
    ...
    ageMinDays: 90,
    exclusive: false,
    features: ["Shared — resold until marked sold", "90+ days old", "Deepest discount", "TCPA consent captured"],
