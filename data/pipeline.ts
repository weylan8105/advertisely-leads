...
export const PIPELINE_STAGES: PipelineStage[] = [
  ...
  { id: "discovery-booked", label: "Discovery Call Booked", tone: "blue" },
  { id: "discovery-no-show", label: "Discovery Call No Show", tone: "amber" },
  { id: "closing-booked", label: "Closing Call Booked", tone: "blue" },
  { id: "closing-no-show", label: "Closing Call No Show / Reschedule", tone: "amber" },
  { id: "closing-ran", label: "Closing Call Ran / Follow up", tone: "indigo" },
